...
**Ícone do app:** **G** dourado inscrito num **círculo preto** (diâmetro = slot do ícone, cantos transparentes — formato circular como o Chrome). Regenerar: `npm run icon:generate`. **Após trocar ícones, feche o app e rode `npm run tauri:dev` de novo.**

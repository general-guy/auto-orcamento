...
**Ícone do app:** o **G** ornamental do timbrado (`assets/app-icon-g.png`) gera os ícones Tauri e o favicon do browser. Para regenerar após trocar a arte: `npm run icon:generate`.

...
**Ícone do app:** **G** dourado inscrito num **círculo branco** (diâmetro = slot do ícone, cantos transparentes). Regenerar: `npm run icon:generate`. **Após trocar ícones, feche o app e rode `npm run tauri:dev` de novo.**

...
// data/ em dist/ serve só como seed no primeiro run (table_load).
// Em runtime, históricos e tabelas vêm de data/ na raiz do repo (ou ao lado do .exe em layout portátil).
